...
namespace Postech.TechChallenge.Persistency.Infra.Data.Migrations
{
    /// <inheritdoc />
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                schema: "contacts",
                table: "tb_region",
                columns: new[] { "region_id", "region_name", "region_state_name" },
                values: new object[,]
                {
                    { (short)1, "Norte", "Acre" },
            ...
            migrationBuilder.InsertData(
                schema: "contacts",
                table: "tb_area_code",
                columns: new[] { "area_code_id", "area_code_region_id", "area_code_value" },
                values: new object[,]
                {
                    { (short)1, (short)25, "11" },
                    { (short)2, (short)25, "12" },
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "contacts",
                table: "tb_contact_phone",
                columns: new[] { "contact_phone_number", "contact_phone_area_code_id" },
                unique: true);
        }

...
namespace Postech.TechChallenge.Persistency.Infra.Data.Migrations
{
    ...
    [Migration("20240928155025_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Postech.TechChallenge.Persistency.Core.ValueObjects.AreaCodeValueObject", b =>
                {
            ...
            modelBuilder.Entity("Postech.TechChallenge.Persistency.Core.ValueObjects.ContactPhoneValueObject", b =>
                {
                    b.Property<int>("ContactPhoneId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Postech.TechChallenge.Persistency.Core.ValueObjects.RegionValueObject", b =>
                {
                    b.Property<short>("RegionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("Postech.TechChallenge.Persistency.Core.Entities.ContactEntity", b =>
                {
                    b.HasOne("Postech.TechChallenge.Persistency.Core.ValueObjects.ContactPhoneValueObject", "ContactPhone")
                        .WithMany()
                    ...
                    b.OwnsOne("Postech.TechChallenge.Persistency.Core.ValueObjects.ContactEmailValueObject", "ContactEmail", b1 =>
                        {
                    ...
                    b.OwnsOne("Postech.TechChallenge.Persistency.Core.ValueObjects.ContactNameValueObject", "ContactName", b1 =>
                        {
                            b1.Property<Guid>("ContactEntityId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Postech.TechChallenge.Persistency.Core.ValueObjects.AreaCodeValueObject", b =>
                {
                    b.HasOne("Postech.TechChallenge.Persistency.Core.ValueObjects.RegionValueObject", "Region")
                        .WithMany()
            ...
            modelBuilder.Entity("Postech.TechChallenge.Persistency.Core.ValueObjects.ContactPhoneValueObject", b =>
                {
                    b.HasOne("Postech.TechChallenge.Persistency.Core.ValueObjects.AreaCodeValueObject", "AreaCode")
                        .WithMany()
